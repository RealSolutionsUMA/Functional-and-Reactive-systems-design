...
In static typed programming languages effects offers greater resilience as the
programmer has to explicitly deal with the effect and can not ignore the
effectful nature like having a possible error, like Either, or being a possibly
future value, i. e. IO.
...
\subsection{Avoiding thread blocking by the use of Futures}
